...
public class ConjunctionFuzzySet implements FuzzySet {
    ...
    public ConjunctionFuzzySet(TNorm tNorm, FuzzySet operand1, FuzzySet operand2) {
        this.tNorm = tNorm;
    ...
    public double getGradeFunction(double xValue) {
        return tNorm.calculateTNorm(operand1.getGradeFunction(xValue),
